...
user2 = User.create!firstName: 'Khoa', lastName: 'Nguyen',  email:'kn@gmail.com', phone:'778-889-1122', userrole: 'user', password:'123', password_digest: User.digest('123')
user3 = User.create!firstName: 'Jashan', lastName: 'Khela',  email:'jd@gmail.com', phone:'778-351rake -5555', userrole: 'service_provider',  password_digest: User.digest('123')
