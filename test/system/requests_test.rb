...
class RequestsTest < ApplicationSystemTestCase
  ...
  test "creating a Request" do
    ...
    fill_in "Budget", with: @request.budget
    fill_in "Category", with: @request.category
    fill_in "City", with: @request.city
    fill_in "Description", with: @request.description
    fill_in "Eventdate", with: @request.eventDate
    fill_in "Name", with: @request.name
    fill_in "Proposaldeadline", with: @request.proposalDeadline
    fill_in "Province", with: @request.province
