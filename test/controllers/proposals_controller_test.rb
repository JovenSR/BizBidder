...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { accept: @proposal.accept, description: @proposal.description, price: @proposal.price } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { accept: @proposal.accept, description: @proposal.description, price: @proposal.price } }
