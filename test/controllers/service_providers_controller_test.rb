...
class ServiceProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_provider" do
    assert_difference('ServiceProvider.count') do
      post service_providers_url, params: { service_provider: { avatar: @service_provider.avatar, city: @service_provider.city, companyName: @service_provider.companyName, email: @service_provider.email, license: @service_provider.license, phone: @service_provider.phone, postalCode: @service_provider.postalCode, province: @service_provider.province, serviceType: @service_provider.serviceType, street: @service_provider.street, website: @service_provider.website } }
    end
  ...
  test "should update service_provider" do
    patch service_provider_url(@service_provider), params: { service_provider: { avatar: @service_provider.avatar, city: @service_provider.city, companyName: @service_provider.companyName, email: @service_provider.email, license: @service_provider.license, phone: @service_provider.phone, postalCode: @service_provider.postalCode, province: @service_provider.province, serviceType: @service_provider.serviceType, street: @service_provider.street, website: @service_provider.website } }
